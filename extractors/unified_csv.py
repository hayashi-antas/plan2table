        ...
        out_rows.append(
            {
                ...
                "機器図 台数": _format_number(vector_count),
                "電気図 台数": str(raster_match_count),
                "台数差": _format_number(count_diff),
                "機器図 消費電力(kW)": vector_capacity.raw_display,
                "機器図 モード容量(kW)": vector_capacity.mode_values_display,
                "機器図 判定モード": vector_capacity.selected_mode,
                "機器図 判定採用容量(kW)": _format_number(vector_capacity.selected_value)
                ...
                "機器図 図面番号": vector_drawing_number,
